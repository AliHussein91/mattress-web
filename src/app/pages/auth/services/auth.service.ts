...
import {
  OTPConfirmation,
  OTPResend,
} from '../register/confirm-registration/confirm-registration.component';
...
export class AuthService {
  ...
  resetPassword(password: ResetPasswordUser): Observable<any> {
    ...
    return this.http.post<any>(
      this.authURL.resetPasswordChangePassword,
      password,
    );
  }
  ...
  singupConfOtp(confirmation: OTPConfirmation): Observable<confirmationRes> {
    return this.http.post<confirmationRes>(
      this.authURL.registerConirmOTP,
      confirmation,
    );
  }
