...
export class HomeComponent {
  ...
  protected productList: Product = new Product();
  ...
  getHomePageData() {
    ...
    this.homePageService.getHomePageData(1).subscribe({
      next: async (value) => {
        const {
          banners,
          brands,
        ...
        console.log(
          '🚀 ~ HomeComponent ~ next:async ~ this.categories:',
          this.categories,
        );
        this.headerCategories = headerCategories.data;
        this.offer = offer.data;
        console.log("🚀 ~ HomeComponent ~ next: ~ this.offer:", this.offer)
